...
import BasketModal, { BasketData } from "@/components/basket-modal";
...
const Navbar = () => {
  ...
  const basketProducts: BasketData[] = [
    {
      name: "Product1",
      price: 5200,
      quantity: 5,
  ...
  return (
    <div>
      <BasketModal data={basketProducts} onOpen={hidden} onClose={handleClose}>
        <nav id="header" className="w-full z-30 top-0 py-1">
          <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
            ...
            <div className="order-1 md:order-2">
              ...
              >
                <svg
                  className="fill-current text-gray-800 mr-2 hover:rotate-45 delay-150 hover:text-blue-500"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            >
              ...
              >
                <svg
                  className="fill-current hover:text-white rounded p-1 mx-1 hover:bg-blue-500"
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
                  viewBox="0 0 24 24"
              ...
              {svgs.map((el) => (
                <div className={onSetColor(el.href)}>
                  <Link
                    className="inline-block no-underline hover:text-black"
                    href={el.href}
                    key={el.href}
