const Carousel = () => {
  return (
    <div>
      <div className="carousel relative container mx-auto max-w-[1600px]">
        <div className="carousel-inner relative overflow-hidden w-full">
          ...
          <div className="carousel-item absolute opacity-0 h-[50vh]">
            <div className="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right bg-gradient-to-r from-stone-200 to-pink-400">
          ...
          <div className="carousel-item absolute opacity-0 bg-cover bg-right h-[50vh]">
            <div className="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right bg-gradient-to-r from-pink-400 to-fuchsia-50">
              <div className="container mx-auto">
                <div className="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                  <p className="text-black text-2xl my-4">
          ...
          />
          <div className="carousel-item absolute opacity-0 h-[50vh]">
            <div className="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-bottom bg-gradient-to-r from-fuchsia-50 to-purple-500">
              <div className="container mx-auto">
                <div className="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                  <p className="text-black text-2xl my-4">
